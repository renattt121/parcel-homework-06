...
function handleToggle(index) {
    (0, _todoStoreJs.toggleTask)(index);
    update();
}
function handleDelete(index) {
    (0, _todoStoreJs.deleteTask)(index);
    update();
}
addBtn.addEventListener("click", ()=>{
    (0, _todoStoreJs.addTask)(input.value);
    input.value = "";
    update();
});

},{"./todoStore.js":"9OkLG","./render.js":"dvMGd"}],"9OkLG":[function(require,module,exports,__globalThis) {
...
function renderTasks(tasks, listElement, onToggle, onDelete) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["6DHTQ","6kb64"], "6kb64", "parcelRequire5d73", {})

//# sourceMappingURL=parcel-homework-06.6528c13b.js.map
